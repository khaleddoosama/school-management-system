                ...
                <div class="card-body">
                    <div class="accordion gray plus-icon round">
                        ...
                        @foreach ($Grades as $Grade)
                            <div class="acd-group">
                                <a href="#" class="acd-heading" id={{ $Grade->id }}>{{ $Grade->Name }}</a>
                                <div class="acd-des">
                                                                                        ...
                                                                                        <div class="col">
                                                                                            ...
                                                                                            <select name="Grade_id"
                                                                                                ...
                                                                                                @foreach ($list_Grades as $list_Grade)
                                                                                                    <option
                                                                                                        value="{{ $list_Grade->id }}"
                                                                                                        @if ($list_Grade->id == $Grade->id) selected @endif>
                                                                                                        {{ $list_Grade->Name }}
                                                                                                    </option>
                                                                                                @endforeach
                                                                                            </select>
                                                                                                ...
                                                                                                <div class="col">
                                                                                                    ...
                                                                                                    <select multiple
                                                                                                        ...
                                                                                                        @foreach ($teachers as $teacher)
                                                                                                            ...
                                                                                                            @foreach ($list_Sections->teachers as $teach)
...
<script>
    $(document).ready(function() {
        ...
        $('.acd-heading').on('click', function() {
            let select = $(this);
            var Grade_id = select[0].id;
    ...
    window.onload = function() {
        document.querySelector('.acd-des').style.display = "none";

        document.querySelector('.acd-group').classList.remove('acd-active');

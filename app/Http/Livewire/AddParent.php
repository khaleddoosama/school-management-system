...
class AddParent extends Component
{
    ...
    public function firstStepSubmit()
    {
        $this->validate([
            ...
            'National_ID_Father' => 'required|min:10|max:10|unique:my__parents,National_ID_Father,' . $this->id,
    ...
    public function secondStepSubmit()
    {
        $this->validate([
            ...
            'National_ID_Mother' => 'required|min:10|max:10|unique:my__parents,National_ID_Mother,' . $this->id,
    ...
    public function firstStepSubmit_edit()
    {
       // dd($this->id);
        $this->validate([
            ...
            'Job_Father' => 'required',
            'Job_Father_en' => 'required',
            'National_ID_Father' => 'required|min:10|max:10|unique:my__parents,National_ID_Father,' . $this->Parent_id,
            'Passport_ID_Father' => 'required|min:10|max:10|unique:my__parents,Passport_ID_Father,' . $this->Parent_id,
            'Phone_Father' => 'required|regex:/^([0-9\s\-\+\(\)]*)$/|min:10',
            'Nationality_Father_id' => 'required',
            'Blood_Type_Father_id' => 'required',
            'Religion_Father_id' => 'required',
    ...
    public function secondStepSubmit_edit()
    {
        $this->validate([
            'Name_Mother' => 'required',
            'Name_Mother_en' => 'required',
            'National_ID_Mother' => 'required|min:10|max:10|unique:my__parents,National_ID_Mother,' . $this->Parent_id,
            'Passport_ID_Mother' => 'required|min:10|max:10|unique:my__parents,Passport_ID_Mother,' . $this->Parent_id,
            'Phone_Mother' => 'required|min:10',
            'Job_Mother' => 'required',
            'Job_Mother_en' => 'required',
            'Nationality_Mother_id' => 'required',
